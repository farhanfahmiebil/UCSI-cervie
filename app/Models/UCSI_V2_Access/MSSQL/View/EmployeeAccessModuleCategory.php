...
//Get Class
class EmployeeAccessModuleCategory extends Model{
  ...
  **************************************************************************************/
  public function getEmployeeAccessModuleCategory($data){

    //Set Table
    $this->table = 'get_employee_access_module_category';
...
// dd($result->get());
    ...
    //Sort Order
    $result = $result->orderBy($this->table.'.module_category_ordering','ASC');
