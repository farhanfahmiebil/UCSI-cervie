...
//Get Class
class SemesterIntake extends Model{
   ...
   * @var string
   */
  protected $table = 'semester_intake';
   ...
   * @var string
   */
  protected $primaryKey = 'semester_intake_id';
  ...
  **************************************************************************************/
  public function checkExist($data){
    ...
    $result = DB::connection($this->connection)->table($this->table)
                                               ->select(
                                                  $this->table.'.semester_intake_id AS semester_intake_id',
                                               ...
                                               ->leftJoin('status AS status',
                                                  function($join){
                                                   ...
                                                   $join->where('status.table','semester_intake');
                                                  }
                                                );

    //Filter Data
    if(isset($data['column']['semester_intake_id']) && $data['column']['semester_intake_id'] != null){$result = $result->where($this->table.'.semester_intake_id',$data['column']['semester_intake_id']);}
  ...
  **************************************************************************************/
  public function selectBox(){
    ...
    $result = $result ->select(
                     ...
                     ->where('status.table','semester_intake')
...
// dd($this->connection);
    ...
    $result = DB::connection($this->connection)
                ...
                ->select(
                    $this->table.'.semester_intake_id AS semester_intake_id',
                    $this->table.'.name AS semester_intake_name',
                    $this->table.'.status_id AS status_id',
