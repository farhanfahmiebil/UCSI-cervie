...
//Get Class
class CervieResearcherStewardship extends Model{
   ...
   * @var string
   */
  protected $table = 'cervie_researcher_stewardship';
  ...
  **************************************************************************************/
  public function createRecord($data){
    ...
    //Set Table
    $table = 'create_cervie_researcher_stewardship';
    ...
    if(!empty($result)){
      ...
      $this->createLog(
        [
          ...
          'event'=>'create',
          'auditable_id'=>$item->stewardship_id,
          'old_value'=>'[]',
  ...
  **************************************************************************************/
  public function readRecord($data){
    ...
    //Set Table
    $table = 'read_cervie_researcher_stewardship';
...
// dd();
  ...
  **************************************************************************************/
  public function updateRecord($data){
    ...
    //Set Table
    $table = 'update_cervie_researcher_stewardship';

    //Read Record
    $item['old'] = $this->readRecord(
      [
        'column'=>[
          'stewardship_id'=>$data['column']['stewardship_id'],
          'employee_id'=>$data['column']['employee_id'],
        ]
      ]
    );
// dd($data);
    ...
    $this->createLog(
      [
        ...
        'table_name'=>$this->table,
        'event'=>'update',
        'auditable_id'=>$data['column']['stewardship_id'],
  ...
  **************************************************************************************/
  public function deleteRecord($data){
    ...
    //Set Table
    $table = 'delete_cervie_researcher_stewardship';
  ...
  **************************************************************************************/
  public function needVerification($data){
    ...
    //Set Table
    $table = 'update_cervie_researcher_stewardship_verification';
