...
class CervieResearcherPosition extends Model{
   ...
   * @var string
   */
  protected $table = 'cervie_researcher_position';
  ...
  **************************************************************************************/
  public function createRecord($data){
    ...
    //Set Table
    $table = 'create_cervie_researcher_position';
  ...
  **************************************************************************************/
  public function readRecord($data){
    ...
    //Set Table
    $table = 'read_cervie_researcher_position';
  ...
  **************************************************************************************/
  public function updateRecord($data){
    ...
    //Set Table
    $table = 'update_cervie_researcher_position';

    //Read Record
    $item['old'] = $this->readRecord(
      [
        'column'=>[
          'position_id'=>$data['column']['position_id'],
          'employee_id'=>$data['column']['employee_id'],
        ]
      ]
    );
    ...
    $this->createLog(
      [
        ...
        'table_name'=>$this->table,
        'event'=>'update',
        'auditable_id'=>$data['column']['position_id'],
  ...
  **************************************************************************************/
  public function deleteRecord($data){
    ...
    //Set Table
    $table = 'delete_cervie_researcher_position';
