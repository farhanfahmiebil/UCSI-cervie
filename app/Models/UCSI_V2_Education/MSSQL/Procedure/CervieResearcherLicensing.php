...
//Get Class
class CervieResearcherLicensing extends Model{
   ...
   * @var string
   */
  protected $table = 'cervie_researcher_licensing';
  ...
  **************************************************************************************/
  public function createRecord($data){
    ...
    //Set Table
    $table = 'create_cervie_researcher_licensing';
    ...
    $result = DB::connection($this->connection)->select($this->query,[
        ...
        $data['column']['technology_name'],
        $data['column']['licensing_name'],
    ...
    if(!empty($result)){
      ...
      $this->createLog(
        [
          ...
          'event'=>'create',
          'auditable_id'=>$item->licensing_id,
          'old_value'=>'[]',
  ...
  **************************************************************************************/
  public function readRecord($data){
    ...
    //Set Table
    $table = 'read_cervie_researcher_licensing';

    //Set Query
    $this->query = 'EXEC '.$table.' ?,?;';
    //Get Result
    $result = DB::connection($this->connection)->select($this->query,[
        $data['column']['licensing_id'],
        $data['column']['employee_id'],
      ]
    );
  ...
  **************************************************************************************/
  public function updateRecord($data){
    ...
    //Set Table
    $table = 'update_cervie_researcher_licensing';

    //Read Record
    $item['old'] = $this->readRecord(
      [
        'column'=>[
          'licensing_id'=>$data['column']['licensing_id'],
          'employee_id'=>$data['column']['employee_id'],
        ]
      ]
    );
    ...
    $this->createLog(
      [
        ...
        'table_name'=>$this->table,
        'event'=>'update',
        'auditable_id'=>$data['column']['licensing_id'],
  ...
  **************************************************************************************/
  public function needVerification($data){
    ...
    //Set Table
    $table = 'update_cervie_researcher_licensing_verification';
  ...
  **************************************************************************************/
  public function deleteRecord($data){
    ...
    //Set Table
    $table = 'delete_cervie_researcher_licensing';
