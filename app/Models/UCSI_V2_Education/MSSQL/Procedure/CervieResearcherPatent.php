...
//Get Class
class CervieResearcherPatent extends Model{
   ...
   * @var string
   */
  protected $table = 'cervie_researcher_patent';
  ...
  **************************************************************************************/
  public function createRecord($data){
    ...
    //Set Table
    $table = 'create_cervie_researcher_patent';
    ...
    $result = DB::connection($this->connection)->select($this->query,[
        ...
        $data['column']['patent_title'],
        $data['column']['patent_no'],
        $data['column']['patent_field_invention_category_id'],
        $data['column']['patent_field_invention_category_other'],
  ...
  **************************************************************************************/
  public function readRecord($data){
    ...
    //Set Table
    $table = 'read_cervie_researcher_patent';
  ...
  **************************************************************************************/
  public function updateRecord($data){
    ...
    //Set Table
    $table = 'update_cervie_researcher_patent';

    //Read Record
    $item['old'] = $this->readRecord(
      [
        'column'=>[
          'patent_id'=>$data['column']['patent_id'],
          'employee_id'=>$data['column']['employee_id'],
        ]
      ]
    );
    ...
    $this->createLog(
      [
        ...
        'table_name'=>$this->table,
        'event'=>'update',
        'auditable_id'=>$data['column']['patent_id'],
  ...
  **************************************************************************************/
  public function deleteRecord($data){
    ...
    //Set Table
    $table = 'delete_cervie_researcher_patent';
