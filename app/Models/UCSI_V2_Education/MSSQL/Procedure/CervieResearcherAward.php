...
class CervieResearcherAward extends Model{
   ...
   * @var string
   */
  protected $table = 'cervie_researcher_award';
  ...
  **************************************************************************************/
  public function createRecord($data){
    ...
    //Set Table
    $table = 'create_cervie_researcher_award';
  ...
  **************************************************************************************/
  public function readRecord($data){
    ...
    //Set Table
    $table = 'read_cervie_researcher_award';
...
// dd();
  ...
  **************************************************************************************/
  public function updateRecord($data){
    ...
    //Set Table
    $table = 'update_cervie_researcher_award';

    //Read Record
    $item['old'] = $this->readRecord(
      [
        'column'=>[
          'award_id'=>$data['column']['award_id'],
          'employee_id'=>$data['column']['employee_id'],
        ]
      ]
    );
// dd($data);
    ...
    $this->createLog(
      [
        ...
        'table_name'=>$this->table,
        'event'=>'update',
        'auditable_id'=>$data['column']['award_id'],
  ...
  **************************************************************************************/
  public function deleteRecord($data){
    ...
    //Set Table
    $table = 'delete_cervie_researcher_award';
  ...
  **************************************************************************************/
  public function needVerification($data){
    ...
    //Set Table
    $table = 'update_cervie_researcher_award_verification';
