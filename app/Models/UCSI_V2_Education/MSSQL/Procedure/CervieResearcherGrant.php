...
//Get Class
class CervieResearcherGrant extends Model{
   ...
   * @var string
   */
  protected $table = 'cervie_researcher_grant';
  ...
  **************************************************************************************/
  public function createRecord($data){
    ...
    //Set Table
    $table = 'create_cervie_researcher_grant';
  ...
  **************************************************************************************/
  public function readRecord($data){
    ...
    //Set Table
    $table = 'read_cervie_researcher_grant';
...
// dd();
  ...
  **************************************************************************************/
  public function updateRecord($data){
    ...
    //Set Table
    $table = 'update_cervie_researcher_grant';

    //Read Record
    $item['old'] = $this->readRecord(
      [
        'column'=>[
          'grant_id'=>$data['column']['grant_id'],
          'employee_id'=>$data['column']['employee_id'],
        ]
      ]
    );
// dd($data);
    ...
    $this->createLog(
      [
        ...
        'table_name'=>$this->table,
        'event'=>'update',
        'auditable_id'=>$data['column']['grant_id'],
  ...
  **************************************************************************************/
  public function deleteRecord($data){
    ...
    //Set Table
    $table = 'delete_cervie_researcher_grant';
