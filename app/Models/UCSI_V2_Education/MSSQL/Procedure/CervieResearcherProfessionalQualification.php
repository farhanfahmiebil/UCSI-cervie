...
//Get Class
class CervieResearcherProfessionalQualification extends Model{
   ...
   * @var string
   */
  protected $table = 'cervie_researcher_professional_qualification';
  ...
  **************************************************************************************/
  public function createRecord($data){
    ...
    //Set Table
    $table = 'create_cervie_researcher_professional_qualification';
    ...
    if(!empty($result)){
      ...
      $item = $this->readRecord(
        [
          'column'=>[
            'professional_qualification_id'=>$result[0]->id,
      ...
      $this->createLog(
        [
          ...
          'event'=>'create',
          'auditable_id'=>$item->professional_qualification_id,
          'old_value'=>'[]',
  ...
  **************************************************************************************/
  public function readRecord($data){
    ...
    //Set Table
    $table = 'read_cervie_researcher_professional_qualification';
...
// dd();
  ...
  **************************************************************************************/
  public function updateRecord($data){
    ...
    //Set Table
    $table = 'update_cervie_researcher_professional_qualification';

    //Read Record
    $item['old'] = $this->readRecord(
      [
        'column'=>[
          'professional_qualification_id'=>$data['column']['professional_qualification_id'],
          'employee_id'=>$data['column']['employee_id'],
        ]
      ]
    );
// dd($data);
    ...
    $this->createLog(
      [
        ...
        'table_name'=>$this->table,
        'event'=>'update',
        'auditable_id'=>$data['column']['professional_qualification_id'],
  ...
  **************************************************************************************/
  public function deleteRecord($data){
    ...
    //Set Table
    $table = 'delete_cervie_researcher_professional_qualification';
