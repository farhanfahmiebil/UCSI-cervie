...
//Get Class
class CervieResearcherCommercialization extends Model{
   ...
   * @var string
   */
  protected $table = 'cervie_researcher_commercialization';
  ...
  **************************************************************************************/
  public function createRecord($data){
    ...
    //Set Table
    $table = 'create_cervie_researcher_commercialization';
    ...
    $result = DB::connection($this->connection)->select($this->query, [
      ...
      $data['column']['country'],
      $data['column']['amount_1'],
      $data['column']['amount_2'],
      $data['column']['amount_3'],
      $data['column']['currency_code_id'],
      $data['column']['commercialization_title'],
      $data['column']['need_verification'],
      $data['column']['remark'],
      $data['column']['remark_user'],
      $data['column']['created_by'],  // This is passed correctly as input
    ]);
    ...
    if(!empty($result)){
      ...
      $item = $this->readRecord(
        [
          'column'=>[
            'commercialization_id'=>$result[0]->id,
      ...
      $this->createLog(
        [
          ...
          'event'=>'create',
          'auditable_id'=>$item->commercialization_id,
          'old_value'=>'[]',
  ...
  **************************************************************************************/
  public function readRecord($data){
    ...
    //Set Table
    $table = 'read_cervie_researcher_commercialization';
    ...
    //Get Result
    $result = DB::connection($this->connection)->select($this->query,[
        $data['column']['commercialization_id'],
        $data['column']['employee_id'],
      ]
    );
// dd();
  ...
  **************************************************************************************/
  public function updateRecord($data){
    ...
    //Set Table
    $table = 'update_cervie_researcher_commercialization';

    //Read Record
    $item['old'] = $this->readRecord(
      [
        'column'=>[
          'commercialization_id'=>$data['column']['commercialization_id'],
          'employee_id'=>$data['column']['employee_id'],
        ]
      ]
    );
// dd($data);
    ...
    $this->createLog(
      [
        ...
        'table_name'=>$this->table,
        'event'=>'update',
        'auditable_id'=>$data['column']['commercialization_id'],
  ...
  **************************************************************************************/
  public function deleteRecord($data){
    ...
    //Set Table
    $table = 'delete_cervie_researcher_commercialization';
  ...
  **************************************************************************************/
  public function needVerification($data){
    ...
    //Set Table
    $table = 'update_cervie_researcher_commercialization_verification';
