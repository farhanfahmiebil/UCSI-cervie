...
//Get Controller Path
namespace App\Http\Controllers\Application\Modules\Dashboard\Employee\Researcher\Portfolio\Organization\User\Qualification\Professional;
...
use App\Models\UCSI_V2_Education\MSSQL\View\CervieResearcherProfessionalQualification AS CervieResearcherProfessionalQualificationView;
...
class IndexController extends Controller{
  ...
  protected $user = 'employee';
    ...
    'category'=>'Researcher Professional Qualification',
		'module'=>'Organization',
		'module_sub'=>'User',
    'item'=>'Professional',
		'gate'=>''
	...
	**************************************************************************************/
	public function routePath(){
		...
		//Set Route Name
		$this->route['name'] = config('routing.'.$this->application.'.modules.dashboard.'.$this->user.'.name').'.researcher.portfolio.organization.user.view.qualification.professional.';

    //Set Route View
		$this->route['view'] = config('routing.'.$this->application.'.modules.dashboard.'.$this->user.'.view').'.researcher.portfolio.organization.user.view.qualification.professional.';
    ...
    //General Information - Researcher Professional Qualification
  ...
  **************************************************************************************/
  public function new(Request $request){
    ...
    $data['table']['column']['cervie']['researcher']['professional']['qualification'] = $this->getDataTable(
      [
    ...
    $data['main']['cervie']['researcher']['professional']['qualification'] = $this->getData(
      [
        'eloquent'=>'pagination',
        'category'=>'professional',
        'column'=>[
    ...
    $data['cervie']['researcher']['table']['control'] = $model['cervie']['researcher']['table']['control']->readRecord(
      [
        'column'=>[
          'table_control_id'=>'cervie_researcher_professional_qualification'
        ]
      ]
    );
  ...
  **************************************************************************************/
  public function create(Request $request){
    ...
    //If Form Token Exist
      ...
      case 'create':
        ...
        $this->getValidateData($request);
          ...
          //Set Model
          $model['cervie']['researcher']['professional']['qualification'] = new CervieResearcherProfessionalQualificationProcedure();

          //Create Main
          $result['main']['create'] = $model['cervie']['researcher']['professional']['qualification']->createRecord(
            [
              'column'=>[
                'employee_id'=>Auth::id(),
        ...
        if($request->has('document')){
          ...
          foreach($request->file('document') as $key=>$value){
            ...
            //Set Path Folder
            $path['folder'] = 'public/resources/researcher/'.trim(Auth::id()).'/document/professional_qualification/'.$result['main']['create']->last_insert_id.'/';;
    ...
    return redirect()->route($hyperlink['page']['list'],['organization_id'=>$request->organization_id,'employee_id'=>$request->employee_id])
                     ...
                     ->with('message','Researcher Professional Qualification Added');
  ...
  public function delete(Request $request){
    ...
    //If Form Token Exist
      ...
      case 'delete':
        ...
        //Delete Main
        $result['main']['delete'] = $model['cervie']['researcher']['professional']['qualification']->deleteRecord(
          [
            'column'=>[
              'professional_qualification_id'=>$request->id,
              'employee_id'=>$request->employee_id,
            ]
          ]
        );
        ...
        //Set Path Folder
        $path['folder'] = 'public/resources/researcher/'.$request->employee_id.'/document/professional_qualification/'.$request->id.'/';
    ...
    return redirect()->route($hyperlink['page']['list'],['organization_id'=>$request->organization_id,'employee_id'=>$request->employee_id])
                     ->with('alert_type','success')
                     ->with('message','Research Professional Qualification Deleted');
  ...
  /**************************************************************************************
    ...
    if(!$request->has('form_token')){abort(555,'Form Token Missing');}
      ...
      case 'delete':
        ...
        //Set Path Folder
        $path['folder'] = 'public/resources/researcher/'.$request->employee_id.'/document/professional_qualification/'.$data['evidence']->table_id.'/';
  ...
  **************************************************************************************/
  public function view(Request $request){
    ...
    //Set Main
    $data['main'] = $model['cervie']['researcher']['professional']['qualification']->readRecord(
      [
        'column'=>[
          'employee_id'=>Auth::id(),
          'professional_qualification_id'=>$request->id
    ...
    //Set Asset
    $asset['document'] = '/public/resources/researcher/'.$request->employee_id.'/document/professional_qualification/'.$request->id.'/';

    //Set Document
    $hyperlink['document'] = $request->root().'/storage/resources/researcher/'.$request->employee_id.'/document/professional_qualification/'.$request->id.'/';
  ...
  /**************************************************************************************
    ...
    //If Form Token Exist
      ...
      //Create Main
      $result['main']['update'] = $model['cervie']['researcher']['professional']['qualification']->updateRecord(
        [
          'column'=>[
            'professional_qualification_id'=>$request->id,
            'employee_id'=>Auth::id(),
    ...
    return redirect()->route($hyperlink['page']['view'],['organization_id'=>$request->organization_id,'employee_id'=>$request->employee_id,'id'=>$request->id])
                     ->with('alert_type','success')
                     ->with('message','Researcher Professional Qualification Saved');
  ...
  **************************************************************************************/
  public function getData($data){
    ...
    //Set Model
    $model['cervie']['researcher']['professional']['qualification'] = new CervieResearcherProfessionalQualificationView();

    //Set Data
    $data = $model['cervie']['researcher']['professional']['qualification']->getList(
      [
