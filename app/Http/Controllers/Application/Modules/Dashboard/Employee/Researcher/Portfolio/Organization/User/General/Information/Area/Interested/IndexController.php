...
class IndexController extends Controller{
  ...
  protected $user = 'employee';
	...
	**************************************************************************************/
    ...
    $this->page['navigation']['tab']['content'] = $this->route['link'].'view.general.information.position.list.index';
...
// dd($data['navigation']['category']['main']);
      //Set Model Resecher
...
// dd(1);
// dd($this->route['link'].'view.navigation.content');
      //Return View
