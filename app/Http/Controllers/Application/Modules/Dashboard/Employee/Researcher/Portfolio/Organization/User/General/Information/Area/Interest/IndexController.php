...
//Get Controller Path
namespace App\Http\Controllers\Application\Modules\Dashboard\Employee\Researcher\Portfolio\Organization\User\General\Information\Area\Interest;
  ...
  protected $user = 'employee';
	...
	**************************************************************************************/
	public function routePath(){
		...
		//Set Route Name
		$this->route['name'] = config('routing.'.$this->application.'.modules.dashboard.'.$this->user.'.name').'.researcher.portfolio.organization.user.view.general.information.area.interest.';

    //Set Route View
		$this->route['view'] = config('routing.'.$this->application.'.modules.dashboard.'.$this->user.'.view').'.researcher.portfolio.organization.user.view.general.information.area.interest.';
    ...
    //General Information - Researcher Area Interest
  ...
  public function create(Request $request){
    ...
    //If Form Token Exist
      ...
      case 'create':
        ...
        //Create Main
        $result['main']['create'] = $model['cervie']['researcher']['area']['interest']->createRecord(
          [
            'column'=>[
              'employee_id'=>Auth::id(),
              'name'=>$request->name,
...
// dd($data['main']['data']);
    ...
    //Set Main
    $data['main'] = $model['cervie']['researcher']['area']['interest']->readRecord(
      [
        'column'=>[
          'employee_id'=>Auth::id(),
          'position_id'=>$request->id
  ...
  /**************************************************************************************
    ...
    return redirect()->route($hyperlink['page']['view'],['organization_id'=>$request->organization_id,'employee_id'=>$request->employee_id,'id'=>$request->id])
                     ->with('alert_type','success')
                     ->with('message','Researcher Area Interest Saved');
