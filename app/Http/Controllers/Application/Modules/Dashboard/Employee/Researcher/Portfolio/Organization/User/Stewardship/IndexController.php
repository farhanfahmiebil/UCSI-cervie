...
//Get Controller Path
namespace App\Http\Controllers\Application\Modules\Dashboard\Employee\Researcher\Portfolio\Organization\User\Stewardship;
...
use App\Models\UCSI_V2_Education\MSSQL\View\CervieResearcherStewardship AS CervieResearcherStewardshipView;
...
use App\Models\UCSI_V2_Education\MSSQL\Procedure\CervieResearcherStewardship AS CervieResearcherStewardshipProcedure;
...
class IndexController extends Controller{
  ...
  protected $user = 'employee';
    ...
    'category'=>'Researcher Stewardship',
		'module'=>'Organization',
		'module_sub'=>'User',
    'item'=>'Stewardship',
		'gate'=>''
	...
	**************************************************************************************/
	public function routePath(){
		...
		//Set Route Name
		$this->route['name'] = config('routing.'.$this->application.'.modules.dashboard.'.$this->user.'.name').'.researcher.portfolio.organization.user.view.stewardship.';

    //Set Route View
		$this->route['view'] = config('routing.'.$this->application.'.modules.dashboard.'.$this->user.'.view').'.researcher.portfolio.organization.user.view.stewardship.';
    ...
    //General Information - Researcher Stewardship
  ...
  **************************************************************************************/
  public function new(Request $request){
    ...
    $data['navigation']['category']['sub'] = $model['navigation']['category']['sub']->getList(
      [
        'column'=>[
          'category'=>'PORTAL',
          'user_type'=>strtoupper('administrator'),
          'navigation_category_code'=>'STEWARDSHIP',
          'domain_url'=>$request->root()
        ]
      ]
    );
    ...
    /*  Researcher Stewardship
   	**************************************************************************************/

    //Set Table Researcher Stewardship
    $data['table']['column']['cervie']['researcher']['stewardship'] = $this->getDataTable(
      [
        'category'=>'stewardship'
      ]
    );

    //Set Main Data Researcher Stewardship
    $data['main']['cervie']['researcher']['stewardship'] = $this->getData(
      [
        'eloquent'=>'pagination',
        'category'=>'stewardship',
        'column'=>[
    ...
    $data['cervie']['researcher']['table']['control'] = $model['cervie']['researcher']['table']['control']->readRecord(
      [
        'column'=>[
          'table_control_id'=>'cervie_researcher_stewardship'
        ]
      ]
    );
  ...
  **************************************************************************************/
  public function create(Request $request){
    ...
    //If Form Token Exist
      ...
      case 'create':
        ...
        $this->getValidateData($request);
          ...
          //Set Model
          $model['cervie']['researcher']['stewardship'] = new CervieResearcherStewardshipProcedure();

          //Create Main
          $result['main']['create'] = $model['cervie']['researcher']['stewardship']->createRecord(
            [
              'column'=>[
                'employee_id'=>Auth::id(),
        ...
        if($request->has('document')){
          ...
          foreach($request->file('document') as $key=>$value){
            ...
            //Set Path Folder
            $path['folder'] = 'public/resources/researcher/'.trim(Auth::id()).'/document/stewardship/'.$result['main']['create']->last_insert_id.'/';;
            ...
            $result['evidence']['create'] = $model['cervie']['researcher']['evidence']->createRecord(
              [
                'column'=>[
                  ...
                  'table_name'=>'cervie_researcher_stewardship',
    ...
    return redirect()->route($hyperlink['page']['list'],['organization_id'=>$request->organization_id,'employee_id'=>$request->employee_id])
                     ...
                     ->with('message','Researcher Stewardship Added');
  ...
  **************************************************************************************/
  public function list(Request $request){
    ...
    //Set Model Award
    $model['cervie']['researcher']['stewardship'] = new CervieResearcherStewardshipView();

    //Get General Award Type
    foreach($data['general']['representation']['category'] as $key=>$value){

      //Set Main Data Researcher Publication
      $data['main']['cervie']['researcher']['stewardship'][$value->representation_category_id] = $model['cervie']['researcher']['stewardship']->getList(
        [
      ...
      $data['table']['column']['cervie']['researcher']['stewardship'][$value->representation_category_id] = $this->getDataTable(
        [
  ...
  public function delete(Request $request){
    ...
    //If Form Token Exist
      ...
      case 'delete':
        ...
        //Delete Main
        $result['main']['delete'] = $model['cervie']['researcher']['stewardship']->deleteRecord(
          [
            'column'=>[
        ...
        //Set Path Folder
        $path['folder'] = 'public/resources/researcher/'.$request->employee_id.'/document/stewardship/'.$request->id.'/';
    ...
    return redirect()->route($hyperlink['page']['list'],['organization_id'=>$request->organization_id,'employee_id'=>$request->employee_id])
                     ->with('alert_type','success')
                     ->with('message','Research Stewardship Deleted');
  ...
  /**************************************************************************************
    ...
    if(!$request->has('form_token')){abort(555,'Form Token Missing');}
      ...
      case 'delete':
        ...
        //Set Path Folder
        $path['folder'] = 'public/resources/researcher/'.$request->employee_id.'/document/stewardship/'.$data['evidence']->table_id.'/';
  ...
  **************************************************************************************/
  public function view(Request $request){
    ...
    //Set Main
    $data['main'] = $model['cervie']['researcher']['stewardship']->readRecord(
      [
        'column'=>[
          'employee_id'=>Auth::id(),
          'stewardship_id'=>$request->id
    ...
    //Set Model
     ...
     if($data['main']->need_verification){
       ...
       //Get Employee Profile
       $data['cervie']['researcher']['log']['stewardship'] = $model['cervie']['researcher']['log']->readRecord(
         [
           'column'=>[
             'employee_id'=>$request->employee_id,
             'table_name'=>'cervie_researcher_stewardship',
       ...
       $data['cervie']['researcher']['log']['evidence'] = $model['cervie']['researcher']['log']->readRecord(
         [
           'column'=>[
             'employee_id'=>$request->employee_id,
             'main_table_name'=>'cervie_researcher_stewardship',
    ...
    //Set Asset
    $asset['document'] = '/public/resources/researcher/'.$request->employee_id.'/document/stewardship/'.$request->id.'/';

    //Set Document
    $hyperlink['document'] = $request->root().'/storage/resources/researcher/'.$request->employee_id.'/document/stewardship/'.$request->id.'/';
  ...
  /**************************************************************************************
    ...
    //If Form Token Exist
      ...
      //Create Main
      $result['main']['update'] = $model['cervie']['researcher']['stewardship']->updateRecord(
        [
          'column'=>[
            'stewardship_id'=>$request->id,
            'employee_id'=>Auth::id(),
    ...
    return redirect()->route($hyperlink['page']['view'],['organization_id'=>$request->organization_id,'employee_id'=>$request->employee_id,'id'=>$request->id])
                     ->with('alert_type','success')
                     ->with('message','Researcher Stewardship Saved');
  ...
  **************************************************************************************/
  public function getData($data){
    ...
    //Set Data
    $data = $model['cervie']['researcher']['stewardship']->getList(
      [
