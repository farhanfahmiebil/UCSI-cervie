...
//Get Controller Path
namespace App\Http\Controllers\Application\Modules\Dashboard\Researcher\Postgraduate\Supervision;
...
class IndexController extends Controller{
  ...
  //Path Header
	...
	**************************************************************************************/
	public function routePath(){
		...
		//Set Route View
		$this->route['view'] = config('routing.'.$this->application.'.modules.dashboard.'.$this->user.'.view').'.postgraduate.supervision.';
    $this->route['name'] = config('routing.'.$this->application.'.modules.dashboard.'.$this->user.'.name').'.postgraduate.supervision.';
  ...
  /**************************************************************************************
    ...
    $data['breadcrumb']['title'] = ['Welcome Back, '.Auth::user()->name];
		...
		$data['title'] = array($this->header['category']);
// dd($data);
    //Set Model Researcher Postgraduate Supervision
    ...
    $data['main']['cervie']['researcher']['postgraduate']['supervision'] = $model['cervie']['researcher']['postgraduate']['supervision']->getList(
      [
        'eloquent'=>'pagination',
        'column'=>[
          'employee_id'=>Auth::id(),
  ...
  /**************************************************************************************
    ...
    //Set Document
    $hyperlink['document'] = $request->root().'/public/storage/resources/researcher/'.trim(Auth::id()).'/document/postgraduate_supervision/'.$request->id.'/';
