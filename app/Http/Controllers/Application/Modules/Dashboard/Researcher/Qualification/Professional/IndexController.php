...
class IndexController extends Controller{
  ...
  //Path Header
	...
	**************************************************************************************/
	public function routePath(){
		...
		//Set Route View
		$this->route['view'] = config('routing.'.$this->application.'.modules.dashboard.'.$this->user.'.view').'.qualification.professional.';
    $this->route['name'] = config('routing.'.$this->application.'.modules.dashboard.'.$this->user.'.name').'.qualification.professional.';
    ...
    //List
    $this->hyperlink['page']['list'] = config('routing.'.$this->application.'.modules.dashboard.'.$this->user.'.name').'.qualification.'.'home.list';
  ...
  /**************************************************************************************
    ...
    //If Form Token Exist
      ...
      case 'create':
        ...
        //Create Main
        $result['main']['create'] = $model['cervie']['researcher']['qualification']['professional']->createRecord(
          [
            'column'=>[
              'employee_id'=>Auth::id(),
  ...
  /**************************************************************************************
    ...
    //If Form Token Exist
      ...
      case 'delete':
        ...
        //Delete Main
        $result['main']['delete'] = $model['cervie']['researcher']['qualification']['professional']->deleteRecord(
          [
            'column'=>[
        ...
        //Set Path Folder
        $path['folder'] = 'public/resources/researcher/'.trim(Auth::id()).'/document/professional_qualification/'.$request->id.'/';
        ...
        $data['main']['verification'] = $model['cervie']['researcher']['qualification']['professional']->needVerification(
          [
            'column'=>[
              'professional_qualification_id'=>$request->id,
              'employee_id'=>Auth::id(),
    ...
    return redirect()->route($hyperlink['page']['list'])
                     ->with('alert_type','success')
                     ->with('message','Professional Qualification Deleted');
  ...
  /**************************************************************************************
    ...
    //If Form Token Exist
      ...
      case 'delete':
        ...
        //Set Path Folder
        $path['folder'] = 'public/resources/researcher/'.trim(Auth::id()).'/document/professional_qualification/'.$data['evidence']->table_id.'/';
        ...
        $data['main']['verification'] = $model['cervie']['researcher']['qualification']['professional']->needVerification(
          [
            'column'=>[
              'professional_qualification_id'=>$data['evidence']->table_id,
              'employee_id'=>Auth::id(),
              'updated_by'=>Auth::id()
            ]
          ]
  ...
  /**************************************************************************************
    ...
    //Set Main
    $data['main'] = $model['cervie']['researcher']['qualification']['professional']->readRecord(
      [
        'column'=>[
          'professional_qualification_id'=>$request->id,
          'employee_id'=>Auth::id(),
    ...
    //Set Asset
    $asset['document'] = '/public/resources/researcher/'.trim(Auth::id()).'/document/professional_qualification/'.$request->id.'/';

    //Set Document
    $hyperlink['document'] = $request->root().'/public/storage/resources/researcher/'.trim(Auth::id()).'/document/professional_qualification/'.$request->id.'/';
  ...
  /**************************************************************************************
    ...
    //If Form Token Exist
      ...
      case 'update':
        ...
        //Update Main
        $result['main']['update'] = $model['cervie']['researcher']['qualification']['professional']->updateRecord(
          [
            'column'=>[
              'professional_qualification_id'=>$request->id,
              'employee_id'=>Auth::id(),
