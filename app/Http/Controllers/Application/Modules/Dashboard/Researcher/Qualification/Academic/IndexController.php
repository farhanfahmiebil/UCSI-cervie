...
//Get Controller Path
namespace App\Http\Controllers\Application\Modules\Dashboard\Researcher\Qualification\Academic;
...
class IndexController extends Controller{
  ...
  //Path Header
	...
	**************************************************************************************/
	public function routePath(){
		...
		//Set Route View
		$this->route['view'] = config('routing.'.$this->application.'.modules.dashboard.'.$this->user.'.view').'.qualification.academic.';
    $this->route['name'] = config('routing.'.$this->application.'.modules.dashboard.'.$this->user.'.name').'.qualification.academic.';
  ...
  /**************************************************************************************
    ...
    //If Form Token Exist
      ...
      case 'create':
        ...
        //Create Main
        $result['main']['create'] = $model['cervie']['researcher']['qualification']['academic']->createRecord(
          [
            'column'=>[
              'employee_id'=>Auth::id(),
  ...
  /**************************************************************************************
    ...
    //If Form Token Exist
      ...
      case 'delete':
        ...
        //Delete Main
        $result['main']['delete'] = $model['cervie']['researcher']['qualification']['academic']->deleteRecord(
          [
            'column'=>[
        ...
        //Set Path Folder
        $path['folder'] = 'public/resources/researcher/'.trim(Auth::id()).'/document/academic_qualification/'.$request->id.'/';
        ...
        $data['main']['verification'] = $model['cervie']['researcher']['qualification']['academic']->needVerification(
          [
            'column'=>[
              'academic_qualification_id'=>$request->id,
              'employee_id'=>Auth::id(),
    ...
    return redirect()->route($hyperlink['page']['list'])
                     ->with('alert_type','success')
                     ->with('message','Academic Qualification Deleted');
  ...
  /**************************************************************************************
    ...
    //If Form Token Exist
      ...
      case 'delete':
        ...
        //Set Path Folder
        $path['folder'] = 'public/resources/researcher/'.trim(Auth::id()).'/document/academic_qualification/'.$data['evidence']->table_id.'/';
  ...
  /**************************************************************************************
    ...
    //Set Main
    $data['main'] = $model['cervie']['researcher']['qualification']['academic']->readRecord(
      [
        'column'=>[
          'academic_qualification_id'=>$request->id,
          'employee_id'=>Auth::id(),
    ...
    //Set Asset
    $asset['document'] = '/public/resources/researcher/'.trim(Auth::id()).'/document/academic_qualification/'.$request->id.'/';

    //Set Document
    $hyperlink['document'] = $request->root().'/public/storage/resources/researcher/'.trim(Auth::id()).'/document/academic_qualification/'.$request->id.'/';
  ...
  /**************************************************************************************
    ...
    //If Form Token Exist
      ...
      case 'update':
        ...
        //Update Main
        $result['main']['update'] = $model['cervie']['researcher']['qualification']['academic']->updateRecord(
          [
            'column'=>[
              'academic_qualification_id'=>$request->id,
              'employee_id'=>Auth::id(),
