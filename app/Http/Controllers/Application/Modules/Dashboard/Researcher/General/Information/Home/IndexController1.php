    ...
    switch($data['category']){
      ...
      case 'position':
        ...
        $table = [
          ...
          1=>[
            'icon'=>'<i class="mdi mdi-format-list-numbers"></i>',
            'name'=>'No',
          ],
          2=>[
            'class'=>'col-md-4',
        ...
        $table = [
          0=>[
            ...
            'checkbox'=>'
              <div class=\'form-check form-check-danger\'>
                <label class=\'form-check-label\'>
                  <input type=\'checkbox\' id=\'selectAllAreaInterest\' class=\'form-check-input\'>
                <i class=\'input-helper\'></i></label>
              </div>
            ',
          ],
          1=>[
            'class'=>'<i class="mdi mdi-format-list-numbers"></i>',
            'name'=>'No',
          ],
          2=>[
            'class'=>'col-md-4',
