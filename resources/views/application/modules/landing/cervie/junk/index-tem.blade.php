...
<div class="container">
	...
	<nav id="menu_navigation" class="menu_nav dragscroll mouse-scroll" role="tablist">
		<div id="menu_navigation_content" class="nav content">
		  <a class="nav_link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">Home Lorem ipsum dolor</a>
		  <a class="nav_link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">Profile</a>
		  <a class="nav_link" id="contact-tab" data-toggle="tab" href="#contact" role="tab" aria-controls="contact" aria-selected="false">Contact</a>
      <a href="#" class="nav_link">Beds</a>
      <a href="#" class="nav_link">Desks</a>
      <a href="#" class="nav_link">Flooring</a>
      <a href="#" class="nav_link">Lighting</a>
      <a href="#" class="nav_link">Mattresses</a>
      <a href="#" class="nav_link">Solar Panels</a>
      <a href="#" class="nav_link">Bookcases</a>
      <a href="#" class="nav_link">Mirrors</a>
      <a href="#" class="nav_link">Rugs</a>
      <a href="#" class="nav_link">Curtains &amp; Blinds</a>
      <a href="#" class="nav_link">Frames &amp; Pictures</a>
      <a href="#" class="nav_link">Wardrobes</a>
      <a href="#" class="nav_link">Storage</a>
      <a href="#" class="nav_link">Decoration</a>
      <a href="#" class="nav_link">Appliances</a>
      <a href="#" class="nav_link">Racks</a>
      <a href="#" class="nav_link">Worktops</a>
...
var ProductNav = document.getElementById('menu_navigation');
...
function doSomething(scroll_pos) {
    menu_navigation.setAttribute('data-overflowing', determineOverflow(menu_navigation_content, ProductNav));
}
...
// If in the middle of a move return
    ...
    if (determineOverflow(menu_navigation_content, ProductNav) === 'left' || determineOverflow(menu_navigation_content, ProductNav) === 'both') {
...
advancer_right.addEventListener('click', function() {
    ...
    if (determineOverflow(menu_navigation_content, ProductNav) === 'right' || determineOverflow(menu_navigation_content, menu_navigation) === 'both') {
