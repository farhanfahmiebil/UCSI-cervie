...
float:left;
  ...
  <div class="container">
    <div class="scroller scroller-left-1"><i class="bi bi-arrow-left text-success"></i></div>
    <div class="scroller scroller-right-1"><i class="bi bi-arrow-right text-success"></i></div>
