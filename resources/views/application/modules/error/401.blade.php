        ...
        <div class="col-12 col-lg-8 text-center position-relative">
          ...
          <div class="position-relative pb-4">
            ...
            <div class="position-relative z-index-1">
              ...
              <!-- error code -->
              <h1 class="mb-2 fw-bolder" style="font-size: 10rem;">401</h1>
              <!-- end error code -->

              <!-- description -->
              <h2 class="mb-4 fs-1">Unauthorized</h2>
              <!-- end description -->

              <!-- information -->
              <p class="mb-4 px-lg-8">We're sorry but it looks<br />you don't have any authorization to access this page.</p>
              <!-- end information -->
            ...
            <!-- hyperlink to home -->
            <div class="pt-4">
              <a href="{{ route(config('routing.application.modules.dashboard.employee.name').'.authorization.login') }}" class="btn btn-primary">
                  Back to Home</a>
            </div>
