        ...
        <div class="col-12 col-lg-8 text-center position-relative">
          ...
          <div class="position-relative pb-4">
            ...
            <div class="position-relative z-index-1">
              ...
              <!-- error code -->
              <h1 class="mb-2 fw-bolder" style="font-size: 10rem;">404</h1>
              <!-- end error code -->

              <!-- description -->
              <h2 class="mb-4 fs-1">Page not found!</h2>
              <!-- end description -->

              <!-- information -->
              <p class="mb-4 px-lg-8">The page you are looking for is not found, Please go back to home</p>
              <!-- end information -->
