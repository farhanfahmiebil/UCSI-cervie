            ...
            <div class="card-body">
              ...
              <script type="text/javascript">
                  ...
                  $('.add-new-team-member').click(function() {
                      ...
                      new_row += '</a>';
                      new_row += '<a href="#" data-href="{{ route($hyperlink['page']['delete']['team']['member'],['id'=>$data['main']->consultancies_id,'team_member_id'=>0,'form_token'=>$form_token['delete']]) }}" class="btn-delete-team-member btn btn-danger text-white">';
