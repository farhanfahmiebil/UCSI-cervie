  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      <div class="d-flex align-items-center justify-content-between">
        ...
        <!-- title -->
				<h4 class="card-title mb-2">Recognition</h4>
        <!-- end title -->
      ...
      @if(count($data['general']['representation']['category']) > 0)
        ...
        @foreach($data['general']['representation']['category'] as $key=>$value)
          ...
          @if(count($data['main']['cervie']['researcher']['recognition'][$value->representation_category_id]) > 0)
            ...
            @foreach($data['main']['cervie']['researcher']['recognition'][$value->representation_category_id] as $k=>$v)
              ...
              {{-- Check General Researcher Recognition Representation Category Matched With Researcher Representation Category --}}
                          ...
                          @if($value->representation_category_id == $v->representation_category_id)
                            ...
                            <tr id="{{ $v->recognition_id }}">
                              ...
                              <td>
                                ...
                                <a href="{{ route($hyperlink['page']['view'],['id'=>$v->recognition_id]) }}" class="btn btn-sm btn-secondary">
                                  <i class="mdi mdi-pencil"></i>
                                </a>

                                <a data-href="{{ route($hyperlink['page']['delete']['main']) }}" class="btn-delete-recognition btn-sm btn btn-danger">
        ...
        <div class="row pt-5 text-center">
          ...
          <!-- title -->
          <h4 class="card-title mb-2">There is No Record Added, You may Add by Clicking New Recognition Above</h4>
          <!-- end title -->
  ...
  $(document).ready(function($){
    ...
    **************************************************************************************/
    ...
    /**************************************************************************************
      Modal Delete
    **************************************************************************************/
    $('[class*="btn-delete-recognition"]').on('click',function(event){
