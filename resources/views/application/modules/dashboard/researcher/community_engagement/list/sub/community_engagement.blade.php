  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      <div class="d-flex align-items-center justify-content-between">
        ...
        <!-- title -->
				<h4 class="card-title mb-2">Community Engagement</h4>
        <!-- end title -->
          ...
          <tbody>
            ...
            @if(count($data['main']['cervie']['researcher']['community']['engagement'])>0)
              ...
              @foreach($data['main']['cervie']['researcher']['community']['engagement'] as $key=>$value)
                ...
                <tr id="{{ $value->community_engagement_id }}">
                  ...
                  <td>
                    ...
                    <a href="{{ route($hyperlink['page']['view'],['id'=>$value->community_engagement_id]) }}" class="btn btn-sm btn-secondary">
