          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="row">
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    <label for="patent_title">Technology Name</label>
                    <input type="text" class="form-control" id="technology_name" name="technology_name" value="{{ old('technology_name') }}" placeholder="Technology Name">
                  </div>
                </div>
                <!-- end patent title -->
              ...
              <div class="row">
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    <label for="patent_no">Licensing Name</label>
                    <input type="text" class="form-control" id="licensing_name" name="licensing_name" value="{{ old('licensing_name') }}" placeholder="Licensing Name">
                  </div>
                </div>
                <!-- end licensing name -->
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="date_filing">Date Start</label>
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="amount" name="amount" value="{{ old('amount') }}" placeholder="">
                  </div>
                </div>
                <!-- end patent amount -->
