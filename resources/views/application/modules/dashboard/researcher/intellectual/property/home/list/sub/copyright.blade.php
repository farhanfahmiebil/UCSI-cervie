  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      <div class="d-flex align-items-center justify-content-between">
        ...
        <!-- title -->
				<h4 class="card-title mb-2">Copyright</h4>
        <!-- end title -->

        <!-- dropdown -->
				<div class="dropdown">
          <a href="{{ route($hyperlink['page']['copyright']['new']) }}" class="btn btn-light px-1">
        ...
        <table class="table table-bordered">
          ...
          <tbody>
            ...
            @if(count($data['main']['cervie']['researcher']['copyright'])>0)
              ...
              @foreach($data['main']['cervie']['researcher']['copyright'] as $key=>$value)
                ...
                <tr id="{{ $value->copyright_id }}">
                  ...
                  <td>
                    ...
                    <a href="{{ route($hyperlink['page']['copyright']['view'],['id'=>$value->copyright_id]) }}" class="btn btn-sm btn-secondary">
                      <i class="mdi mdi-pencil"></i>
                    </a>

                    <a data-href="{{ route($hyperlink['page']['copyright']['delete']) }}" class="btn-delete-copyright btn-sm btn btn-danger">
              ...
              @endforeach
              {{-- End Get Researcher copyright Data --}}
            ...
            @endif
            {{-- End Check Researcher copyright Exist --}}
  ...
  **************************************************************************************/
  $(document).ready(function($){
    ...
    /**************************************************************************************
      Modal Delete
    **************************************************************************************/
    $('[class*="btn-delete-copyright"]').on('click',function(event){
