  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      <div class="d-flex align-items-center justify-content-between">
        ...
        <!-- title -->
				<h4 class="card-title mb-2">Patent</h4>
        <!-- end title -->

        <!-- dropdown -->
				<div class="dropdown">
          <a href="{{ route($hyperlink['page']['patent']['new']) }}" class="btn btn-light px-1">
              ...
              @foreach($data['main']['cervie']['researcher']['patent'] as $key=>$value)
                ...
                <tr id="{{ $value->patent_id }}">
                  ...
                  <td>
                    ...
                    <a href="{{ route($hyperlink['page']['patent']['view'],['id'=>$value->patent_id]) }}" class="btn btn-sm btn-secondary">
                      <i class="mdi mdi-pencil"></i>
                    </a>

                    <a data-href="{{ route($hyperlink['page']['patent']['delete']) }}" class="btn-delete-patent btn-sm btn btn-danger">
