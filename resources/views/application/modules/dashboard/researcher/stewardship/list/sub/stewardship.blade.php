  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      <div class="d-flex align-items-center justify-content-between">
        ...
        <!-- title -->
				<h4 class="card-title mb-2">Stewardship</h4>
        <!-- end title -->
      ...
      @if(count($data['general']['representation']['category']) > 0)
                          ...
                          @if($value->representation_category_id == $v->representation_category_id)
                            ...
                            <tr id="{{ $v->stewardship_id }}">
                              ...
                              <td>
                                ...
                                <a href="{{ route($hyperlink['page']['view'],['id'=>$v->stewardship_id]) }}" class="btn btn-sm btn-secondary">
                                  <i class="mdi mdi-pencil"></i>
                                </a>

                                <a data-href="{{ route($hyperlink['page']['delete']['main']) }}" class="btn-delete-stewardship btn-sm btn btn-danger">
        ...
        <div class="row pt-5 text-center">
          ...
          <!-- title -->
          <h4 class="card-title mb-2">There is No Record Added, You may Add by Clicking New Stewardship Above</h4>
          <!-- end title -->
  ...
  $(document).ready(function($){
    ...
    **************************************************************************************/
    ...
    /**************************************************************************************
      Modal Delete
    **************************************************************************************/
    $('[class*="btn-delete-stewardship"]').on('click',function(event){
