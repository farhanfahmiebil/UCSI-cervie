...
<div class="tab-pane fade {{ ((request()->tab_category == 'personal')?'show active':'') }}" id="personal" role="tabpanel">
  ...
  <!-- form -->
  <form action="{{ route($hyperlink['page']['update'],['id'=>request()->id,'tab'=>'tab','tab_category'=>'personal']) }}" method="POST">
    {{csrf_field()}}
            ...
            <div class="row gx-3">
              ...
              <div class="col-6">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="salutation_id" name="salutation_id" placeholder="" value="">
                </div>
                <!-- end salutation -->
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="first_name" name="first_name" placeholder="First Name" value="{{ $data['employee']['profile']->first_name }}" >
                </div>
                <!-- end first name -->
              ...
              <div class="col-6">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control"  id="middle_name" name="middle_name" placeholder="Middle Name" value="{{ $data['employee']['profile']->middle_name }}">
                </div>
                <!-- end middle name -->
              ...
              <div class="col-6">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control"  id="last_name" name="last_name" placeholder="Last Name" value="{{ $data['employee']['profile']->last_name }}">
                </div>
                <!-- end last name -->
                ...
                <div class="mb-3">
                  ...
                  <div class="input-group">
                    <input type="date" class="form-control datepicker-opens-left" id="dob" name="dob" placeholder="DD/MM/YYYY" value="{{ $data['employee']['profile']->dob }}"/>
              ...
              <div class="col-6">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="nickname" name="nickname" placeholder="nickname" value="{{ $data['employee']['profile']->nickname }}">
                </div>
                <!-- end nickname -->
