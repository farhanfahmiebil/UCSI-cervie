        ...
        <div class="stats-tile d-flex align-items-center position-relative tile-primary cursor-pointer">
          <div class="icon-box xxl me-3">
            @php
              ...
              //Set Default Avatar;
              $image['module']['main'] = URL::asset('storage/resources/module/'.$value->module_id.'/icon/index.png');

            @endphp

            <img src="{{ $image['module']['main'] }}" alt="" style="width:160px">
...
<script type="text/javascript">
 ...
 // console.log(value.module_sub_name);
               //Set Html Module
               $('#result_module').html(constructHTML(value));
