            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="m-0">
									...
									<input type="text" class="form-control" id="module_company_id" name="module_company_id" value="{{ $data['main']->module_company_id }}" placeholder="Example: UCSI_GROUP_{CATEGORY}">
								</div>
              </div>
              ...
              <div class="col-md-6">
                <div class="m-0">
									...
									<input type="text" class="form-control" id="module_company_name" name="module_company_name" value="{{ $data['main']->module_company_name }}" placeholder="">
								</div>
              </div>
            ...
            <div class="row pt-3">
                  ...
                  <select class="form-control select2" id="company_id" name="company_id">
                    ...
                    @if(count($data['general']['company']) >= 1)
                      ...
                      @foreach($data['general']['company'] as $key=>$value)
                        ...
                        <option value="{{ $value->company_id }}" {{ (($value->company_id == $data['main']->company_id)?'selected':'') }}>{{ ucwords($value->company_name) }}</option>
              ...
              <div class="col-md-3">
                <div class="m-0">
									...
									<input type="text" class="form-control" id="icon" name="icon" value="{{ $data['main']->module_company_icon }}" placeholder="">
								</div>
              </div>
              <!-- end icon -->
              ...
              <div class="col-md-3">
                <div class="m-0">
									...
									<input type="number" class="form-control" id="ordering" name="ordering" value="{{ $data['main']->module_company_ordering }}" placeholder="">
								</div>
              </div>
              <!-- end ordering -->
                  ...
                  <select class="form-control select2" id="status_id" name="status_id">
                    ...
                    @if(count($data['general']['status']) >= 1)
                      ...
                      @foreach($data['general']['status'] as $key=>$value)
                        ...
                        <option value="{{ $value->status_id }}" {{ (($value->status_id == $data['main']->status_id)?'selected':'') }}>{{ ucwords($value->name) }}</option>
