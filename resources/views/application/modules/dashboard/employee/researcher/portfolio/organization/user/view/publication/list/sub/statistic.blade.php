...
if (indexingData && indexingData.year && indexingData.label && indexingData.data) {
    ...
    //     var dataForLabel = years.map(function(year) {
    ...
    // Data passed from PHP (this is the structure you get after PHP processes it)
  var indexingData = @json($data['graph']['indexing']['body']);
  ...
  var indexingOptions = {
      ...
      series: series,
      xaxis: {
          categories: years,  // Years will be displayed on the X-axis
      },
      yaxis: {
          title: {
    ...
    var chart = new ApexCharts(document.querySelector("#graphPublicationByIndexingBody"), indexingOptions);
    chart.render();
