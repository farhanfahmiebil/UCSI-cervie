...
<div class="card">
  ...
  <div class="card-header">
    ...
    <div class="d-flex align-items-center justify-content-between">
      ...
      <!-- title -->
      <h4 class="card-title mb-2">Researcher Professional Qualification</h4>
      <!-- end title -->
    ...
    <div class="table-responsive">
      ...
      <table class="table table-striped">
        ...
        <thead class="bg-danger text-white mx-3">
          ...
          @if(isset($data['table']['column']['cervie']['researcher']['professional']['qualification']) && count($data['table']['column']['cervie']['researcher']['professional']['qualification']) >= 1)

              {{-- Get Table Column Data --}}
              @foreach($data['table']['column']['cervie']['researcher']['professional']['qualification'] as $key => $value)
        ...
        <tbody>
          ...
          @if(count($data['main']['cervie']['researcher']['professional']['qualification']) > 0)

            {{-- Get Researcher Position Data --}}
            @foreach($data['main']['cervie']['researcher']['professional']['qualification'] as $key=>$value)

              <tr id="{{ $value->professional_qualification_id }}" class="bg-danger">
                ...
                <td>
                  <a href="{{ route($hyperlink['page']['view'],['organization_id'=>request()->route('organization_id'),'employee_id'=>request()->route('employee_id'),'id'=>$value->professional_qualification_id]) }}" class="btn btn-sm btn-secondary">
                    <i class="bi bi-pencil"></i>
                  </a>

                  <a data-href="{{ route($hyperlink['page']['delete']['main'],['organization_id'=>request()->route('organization_id'),'employee_id'=>request()->route('employee_id'),'id'=>$value->professional_qualification_id]) }}" class="btn-delete-main btn btn-sm btn-danger">
          ...
          @else
            ...
            <tr>
              <td colspan="{{ count($data['table']['column']['cervie']['researcher']['professional']['qualification']) }}">No Data</td>
            </tr>
      ...
      <div class="col-12 pt-3">
        ...
        @if(count($data['main']['cervie']['researcher']['professional']['qualification']) >= 1)

          <!-- paginate -->
          {{ $data['main']['cervie']['researcher']['professional']['qualification']->appends(request()->input())->links(Config::get('routing.application.modules.dashboard.researcher.layout').'.navigation.pagination.index',['navigation'=>['alignment'=>'center']]) }}
          <!-- end paginate -->
