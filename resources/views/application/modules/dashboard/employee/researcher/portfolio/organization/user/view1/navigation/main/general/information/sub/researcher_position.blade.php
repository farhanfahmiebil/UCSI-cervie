...
<div class="card">
  ...
  <div class="card-body">
    ...
    <div class="d-flex align-items-center justify-content-between">
      ...
      <!-- dropdown -->
      <div class="dropdown">
        <a href="{{ route($hyperlink['page']['position']['new'],['organization_id'=>request()->route('organization_id'),'id'=>request()->route('id'),'tab_category'=>request()->route('tab_category'),'tab_category_sub'=>request()->route('tab_category_sub')]) }}" class="btn btn-light px-1">
