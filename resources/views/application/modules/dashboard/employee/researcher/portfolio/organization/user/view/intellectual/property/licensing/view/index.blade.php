  ...
  <div class="col-lg-12 col-sm-12 flex-column d-flex stretch-card">
    ...
    <div class="row">
      ...
      <div class="col-12">
        ...
        @if(count(get_object_vars($data['cervie']['researcher']['log']['licensing'])) === 0)
        <div class="alert alert-warning" role="alert">
        ...
        {{-- Check Data Log --}}
        @if(!empty($data['cervie']['researcher']['log']['licensing']) && isset($data['cervie']['researcher']['log']['licensing']->updated_at) && $data['cervie']['researcher']['log']['licensing']->updated_at != null)
            <div class="alert alert-warning" role="alert">
                <h4 class="card-title text-white">Old Values</h4>
                <ol class="list-group list-group-numbered">
                    {{-- Check if licensing_title is set --}}
                    @if(isset($data['cervie']['researcher']['log']['licensing']->technology_name))
                        <li class="list-group-item d-flex justify-content-between align-items-start">
                            <div class="ms-2 me-auto">
                                <div class="fw-bold">Technology Name</div>
                                {{ $data['cervie']['researcher']['log']['licensing']->technology_name }}
                            </div>
                        </li>
                    @endif

                    {{-- Check if designation is set --}}
                    @if(isset($data['cervie']['researcher']['log']['licensing']->licensing_name))
                        <li class="list-group-item d-flex justify-content-between align-items-start">
                            <div class="ms-2 me-auto">
                                <div class="fw-bold">Licensing Name</div>
                                {{ $data['cervie']['researcher']['log']['licensing']->licensing_name }}
                            </div>
                        </li>
                    @endif

                    @if(isset($data['cervie']['researcher']['log']['licensing']->date_start))
                        <li class="list-group-item d-flex justify-content-between align-items-start">
                            <div class="ms-2 me-auto">
                                ...
                                to
                                @if(isset($data['cervie']['researcher']['log']['licensing']->is_lifetime) && $data['cervie']['researcher']['log']['licensing']->is_lifetime)
                                    Is Lifetime
                                @elseif(isset($data['cervie']['researcher']['log']['licensing']->date_end))
                    ...
                    @if(isset($data['cervie']['researcher']['log']['licensing']->amount))
                        <li class="list-group-item d-flex justify-content-between align-items-start">
                            <div class="ms-2 me-auto">
                                <div class="fw-bold">Amount</div>
                                {{ $data['cervie']['researcher']['log']['licensing']->amount }}
                            </div>
                        </li>
                    @endif

                    {{-- Check if project_role_name is set --}}
                    @if(isset($data['cervie']['researcher']['log']['licensing']->project_role_name))
                        <li class="list-group-item d-flex justify-content-between align-items-start">
                            <div class="ms-2 me-auto">
                                <div class="fw-bold">Licensing Level</div>
                                {{ $data['cervie']['researcher']['log']['licensing']->project_role_name }}
                            </div>
                        </li>
                    @endif

                    {{-- Check if country is set --}}
                    @if(isset($data['cervie']['researcher']['log']['licensing']->country))
                        <li class="list-group-item d-flex justify-content-between align-items-start">
                            <div class="ms-2 me-auto">
                                <div class="fw-bold">Country</div>
                                {{ $data['cervie']['researcher']['log']['licensing']->country }}
                            </div>
                        </li>
                    @endif

                    {{-- Check if status_name is set --}}
                    @if(isset($data['cervie']['researcher']['log']['licensing']->status_name))
                        <li class="list-group-item d-flex justify-content-between align-items-start">
                            <div class="ms-2 me-auto">
                                <div class="fw-bold">Status</div>
                                {{ $data['cervie']['researcher']['log']['licensing']->status_name }}
                            </div>
                        </li>
                    @endif
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div class="row pt-3">
              ...
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="technology_name" name="technology_name" value="{{ $data['main']->technology_name }}" placeholder="Technology Name">
                </div>
              </div>
              <!-- end licensing title -->
            ...
            <div class="row pt-3">
              ...
              <div class="col-md-12">
                <div class="form-group">
                  <label for="licensing_name">Licensing Name</label>
                  <input type="text" class="form-control" id="licensing_name" name="licensing_name" value="{{ $data['main']->licensing_name }}" placeholder="Licensing Name">
                </div>
              </div>
              <!-- end licensing name -->
            ...
            <div class="row pt-3">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <label for="amount">Licensing Amount</label>
                  <input type="text" class="form-control" id="amount" name="amount" value="{{ $data['main']->amount }}" placeholder="Licensing Name">
                </div>
              </div>
              <!-- end licensing amount -->

              <!-- representation category -->
              <div class="col-md-6">
                <div class="form-group">
                  <label for="representation_category_id">Licensing Level</label>
                        ...
                        <tr id="{{ $value->evidence_id }}">
                          ...
                          <td>
                            @if(Storage::exists($asset['document'].$value->file_id.'.'.$value->file_extension))
                              ...
                              <!-- remove file -->
                              <a href="#" data-href="{{ route($hyperlink['page']['delete']['evidence'],['organization_id'=>request()->organization_id,'employee_id'=>request()->employee_id,'id'=>$data['main']->licensing_id,'evidence_id'=>$value->evidence_id,'file_id'=>$value->file_id,'form_token'=>$form_token['delete']]) }}" class="btn-delete-evidence btn btn-danger text-white">
          ...
          <div class="card-footer">
            ...
            <div class="row text-end">
              ...
              <div class="col-md-12">
                ...
                <input type="hidden" id="id" name="id" value="{{ $data['main']->licensing_id }}">
...
// console.log(id)
    ...
    **************************************************************************************/
    ...
    //Toggle licensing Field Invention Category
    togglelicensingFieldInventionCategory();

    //Representation Category On Change
    $('#licensing_field_invention_category_id').on('change',function(){
    ...
    function togglelicensingFieldInventionCategory(){

      // Get the selected value from the representation category dropdown
      var selected_value = $('#licensing_field_invention_category_id').val();

      // Get the selected text (name) from the dropdown
      var selected_text = $('#licensing_field_invention_category_id option:selected').text();
      ...
      if (selected_text === 'Other'){
        ...
        //Slide Down
        $('#group_licensing_field_invention_category_other').removeClass('d-none').slideDown();

      }else{

        //Slide Up
        $('#group_licensing_field_invention_category_other').slideUp(500,function(){
          $(this).addClass('d-none');
        });

        //Set Null
        $('#licensing_field_invention_category_other').val('');
      }
