...
<div class="tab-pane fade {{ ((request()->tab_category == 'avatar')?'show active':'') }}" id="avatar" role="tabpanel">
  ...
  <!-- form -->
  <form action="{{ route($hyperlink['page']['update'],['id'=>request()->id,'tab'=>'tab','tab_category'=>'avatar']) }}" method="POST" enctype="multipart/form-data">
    @csrf
            ...
            <div class="mb-3">
              ...
              <div class="dropzone sm needsclick dz-clickable">
                <div class="dz-message needsclick">
                  <img src="{{ $avatar }}" class="img-7xx rounded-circle" />
                </div>
              </div>
              <!-- end dropzone -->
