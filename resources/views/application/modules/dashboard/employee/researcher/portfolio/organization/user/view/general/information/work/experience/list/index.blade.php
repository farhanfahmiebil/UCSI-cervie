...
<div class="card">
  ...
  <div class="card-header">
    ...
    <div class="d-flex align-items-center justify-content-between">
      ...
      <!-- title -->
      <h4 class="card-title mb-2">Researcher Work Experience</h4>
      <!-- end title -->
        ...
        <tbody>
          ...
          @if(count($data['main']['cervie']['researcher']['work']['experience']) > 0)
            ...
            @foreach($data['main']['cervie']['researcher']['work']['experience'] as $key=>$value)
              ...
              <tr id="{{ $value->work_experience_id }}" class="bg-danger">

                {{-- Check if Checkbox Status True --}}
                @if($checkbox['status'])
                  <td>
                    <div class="form-check">
                      <input type="checkbox" name="id[]" class="form-check-input selectBox" value="{{ $value->work_experience_id }}"/>
                    </div>
                  </td>
                @endif
                ...
                <td>
                  <a href="{{ route($hyperlink['page']['view'],['organization_id'=>request()->route('organization_id'),'employee_id'=>request()->route('employee_id'),'id'=>$value->work_experience_id]) }}" class="btn btn-sm btn-secondary">
                    <i class="bi bi-pencil"></i>
                  </a>

                  <a data-href="{{ route($hyperlink['page']['delete']['main'],['organization_id'=>request()->route('organization_id'),'employee_id'=>request()->route('employee_id'),'id'=>$value->work_experience_id]) }}" class="btn-delete-main btn btn-sm btn-danger">
