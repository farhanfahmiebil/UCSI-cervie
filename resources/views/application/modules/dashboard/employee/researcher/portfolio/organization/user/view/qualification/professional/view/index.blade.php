      ...
      <div class="col-12 grid-margin stretch-card">
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <!-- card title -->
            <h4 class="card-title">Professional Qualification Information</h4>
            <!-- end card title -->
            ...
            <div class="row">
              ...
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="qualification" name="qualification" value="{{ $data['main']->qualification }}" placeholder="Name">
                </div>
              </div>
              <!-- end name -->
                        ...
                        <tr id="{{ $value->evidence_id }}">
                          ...
                          <td>
                            @if(Storage::exists($asset['document'].$value->file_id.'.'.$value->file_extension))
                              ...
                              <!-- remove file -->
                              <a href="#" data-href="{{ route($hyperlink['page']['delete']['evidence'],['organization_id'=>request()->organization_id,'employee_id'=>request()->employee_id,'id'=>$data['main']->professional_qualification_id,'evidence_id'=>$value->evidence_id,'file_id'=>$value->file_id,'form_token'=>$form_token['delete']]) }}" class="btn-delete-evidence btn btn-danger text-white">
