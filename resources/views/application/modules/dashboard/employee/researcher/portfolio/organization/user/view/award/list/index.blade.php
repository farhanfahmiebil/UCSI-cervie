...
<div class="card">
  ...
  <div class="card-header">
    ...
    <div class="d-flex align-items-center justify-content-between">
      ...
      <!-- title -->
      <h4 class="card-title mb-2">Researcher Award</h4>
      <!-- end title -->
                      ...
                      {{-- If Representation Category Matched --}}
                        @if($value->representation_category_id == $v->representation_category_id)
                          ...
                          <tr id="{{ $v->award_id }}">
                            ...
                            <td>
                              <a href="{{ route($hyperlink['page']['view'],['organization_id'=>request()->route('organization_id'),'employee_id'=>request()->route('employee_id'),'id'=>$v->award_id]) }}" class="btn btn-sm btn-secondary">
                                <i class="bi bi-pencil"></i>
                              </a>

                              <a data-href="{{ route($hyperlink['page']['delete']['main'],['organization_id'=>request()->route('organization_id'),'employee_id'=>request()->route('employee_id'),'id'=>$v->award_id]) }}" class="btn-delete-main btn btn-sm btn-danger">
