            ...
            @foreach($data['main']['cervie']['researcher']['position'] as $key=>$value)
              ...
              <tr id="{{ $value->position_id }}" class="bg-danger">
                ...
                <td>
                  ...
                  <a data-href="{{ route($hyperlink['page']['delete']['main'],['organization_id'=>request()->route('organization_id'),'employee_id'=>request()->route('employee_id'),'id'=>$value->position_id]) }}" class="modal-delete-position btn btn-sm btn-danger">
