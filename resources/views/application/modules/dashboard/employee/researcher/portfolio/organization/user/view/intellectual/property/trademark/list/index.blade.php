...
<div class="card">
  ...
  <div class="card-header">
    ...
    <div class="d-flex align-items-center justify-content-between">
      ...
      <!-- title -->
      <h4 class="card-title mb-2">Researcher Trademark</h4>
      <!-- end title -->
        ...
        <tbody>
          ...
          @if(count($data['main']['cervie']['researcher']['trademark']) > 0)
            ...
            @foreach($data['main']['cervie']['researcher']['trademark'] as $key=>$value)
              ...
              <tr id="{{ $value->trademark_id }}" class="bg-danger">
                ...
                <td>
                  <a href="{{ route($hyperlink['page']['view'],['organization_id'=>request()->route('organization_id'),'employee_id'=>request()->route('employee_id'),'id'=>$value->trademark_id]) }}" class="btn btn-sm btn-secondary">
                    <i class="bi bi-pencil"></i>
                  </a>

                  <a data-href="{{ route($hyperlink['page']['delete']['main'],['organization_id'=>request()->route('organization_id'),'employee_id'=>request()->route('employee_id'),'id'=>$value->trademark_id]) }}" class="btn-delete-main btn btn-sm btn-danger">
