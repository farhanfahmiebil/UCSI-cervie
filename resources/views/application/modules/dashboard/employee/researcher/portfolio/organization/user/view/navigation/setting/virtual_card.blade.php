            ...
            <div class="dz-message needsclick p-3 text-center">
              {!!
                QrCode::size(200)
                      ->color(255,0,0)
                      ->margin(1)
                      ->generate(route($hyperlink['page']['virtual']['card'],['id'=>$data['employee']['profile']->employee_id]))
              !!}
              <br>
            ...
            <div class="mb-3">
              <div class="form-group">
                ...
                <div class="input-group">
									<input type="text" class="form-control" name="" value="{{ route($hyperlink['page']['virtual']['card'],['id'=>request()->id]) }}" disabled>
									<a href="{{ route($hyperlink['page']['virtual']['card'],['id'=>request()->id]) }}" class="btn btn-danger" target=”_blank”>
										View
									</a>
								</div>
              </div>
