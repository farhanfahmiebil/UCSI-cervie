        ...
        <div class="row gx-3">
          ...
          <div class="col-6 pb-3">
            ...
            <div class="form-group">
              ...
              <input class="form-control" type="text" name="submission_id" value="{{ $value->submission_id }}" readonly>
            </div>
          ...
          <div class="col-6 pb-3">
            ...
            <div class="form-group">
              ...
              <input class="form-control" type="text" name="long_id" value="{{ $value->long_id }}" readonly>
            </div>
          ...
          <div class="col-6 pb-3">
            ...
            <div class="form-group">
              ...
              <input class="form-control" type="text" name="" value="{{ $value->status_http_code }}">
            </div>
          ...
          <div class="col-6 pb-3">
            ...
            <div class="form-group">
              <label for="invoice_type_id">Document Status</label>
              <input class="form-control" type="text" name="" value="{{ $value->status }}">
            </div>
          ...
          <div class="col-6 pb-3">
            ...
            <div class="form-group">
              <label for="invoice_type_id">Document Description</label>
