          ...
          <div class="row">
            ...
            <div class="col-6">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="customer_tin_no" value="IG24475680050">
            ...
            <div class="col-6">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="customer_tax_identification_type_id" value="NRIC">
          ...
          <div class="row pt-3">
            ...
            <div class="col-6">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="customer_tax_identification_type_value" value="871021915087">
        ...
        <div class="row pt-3">
          ...
          <div class="col-6">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="use_signature" value="true">
          ...
          <div class="col-6">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="signature_version" value="1.1">
        ...
        <div class="row pt-3">
          ...
          <div class="col-6">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="use_testing_customer" value="1">
          ...
          <div class="col-6">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="einvoice_submission_category" value="single">
