...
<head>
  ...
  <body>
    ...
    @if(!in_array(Request::segment(5),array('register')))
    ...
    <!--Divider-->
    <svg preserveAspectRatio="none" width="100%" height="64" viewBox="0 0 1015 162" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <footer class="footer bg-dark text-white position-relative">
      ...
      <div class="container pb-8 pt-8">
        <div class="border-top pt-4 text-center d-md-flex justify-content-md-between align-items-center">
          ...
          <small class="d-block text-muted">© Copyright
            <script>
