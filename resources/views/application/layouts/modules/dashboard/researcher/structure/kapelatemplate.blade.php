  								...
  								<div class="card-body">
  									<div class="row">
  										<div class="col-lg-4"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
  											...
  											<canvas id="salesDifference" width="373" height="186" style="display: block; width: 373px; height: 186px;" class="chartjs-render-monitor"></canvas>
  										...
  										<div class="col-lg-5">
  											...
  											<div class="row">
  												...
  												<div class="col-sm-8 grid-margin"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
  													<canvas id="bestSellers" width="306" height="153" style="display: block; width: 306px; height: 153px;" class="chartjs-render-monitor"></canvas>
  												</div>
  											</div>
  											<p class="mt-3 mb-4 mb-lg-0">Lorem ipsum dolor sit amet,
  												consectetur adipisicing elit.
  					...
  					<div class="row">
  						<div class="col-lg-2 grid-margin stretch-card">
  							<div class="card"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
  								...
  								<canvas id="newClient" width="287" height="143" style="display: block;" class="chartjs-render-monitor"></canvas>
  						...
  						<div class="col-lg-2 grid-margin stretch-card">
  							<div class="card"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
  								...
  								<canvas id="allProducts" width="287" height="143" style="display: block;" class="chartjs-render-monitor"></canvas>
  						...
  						<div class="col-lg-2 grid-margin stretch-card">
  							<div class="card"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
  								...
  								<canvas id="invoices" width="287" height="143" style="display: block;" class="chartjs-render-monitor"></canvas>
  						...
  						<div class="col-lg-2 grid-margin stretch-card">
  							<div class="card"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
  								...
  								<canvas id="projects" width="287" height="143" style="display: block;" class="chartjs-render-monitor"></canvas>
  						...
  						<div class="col-lg-2 grid-margin stretch-card">
  							<div class="card"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
  								...
  								<canvas id="orderRecieved" width="287" height="143" style="display: block;" class="chartjs-render-monitor"></canvas>
  						...
  						<div class="col-lg-2 grid-margin stretch-card">
  							<div class="card"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
  								...
  								<canvas id="transactions" width="287" height="143" style="display: block;" class="chartjs-render-monitor"></canvas>
  						...
  						<div class="col-sm-6 grid-margin grid-margin-md-0 stretch-card">
  							<div class="card">
  								<div class="card-body"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
  									...
  									<canvas id="supportTracker" width="862" height="431" style="display: block; width: 862px; height: 431px;" class="chartjs-render-monitor"></canvas>
  								</div>
  							</div>
  						</div>
  						<div class="col-sm-6 grid-margin grid-margin-md-0 stretch-card">
